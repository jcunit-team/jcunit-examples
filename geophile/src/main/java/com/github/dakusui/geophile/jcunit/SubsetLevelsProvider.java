...
public abstract class SubsetLevelsProvider<E> implements LevelsProvider {
  static abstract class Base<E> extends SubsetLevelsProvider<E> {
  ...
  static class PassThrough extends Base<String> {
    public PassThrough(int min, int max, String... names) {
      super(min, max, names);
    }
  ...
  static abstract class Concretizable<EE, E extends Concretizer<T, EE>, T> extends Base<E> {
    public Concretizable(int min, int max, String... names) {
      super(min, max, names);
    }
  }

  static class MethodBased<EE, E extends Concretizer<T,EE>, T> extends Concretizable<EE, E, T> {
